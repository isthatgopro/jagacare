...
<div align="center">
  <img src="./assets/diagrams/flowchart.png" alt="JagaCare system flowchart" width="900" />
</div>
...
| :-- | :-- | :-- |
| JagaBot | A caregiver facing assistant UI for voice first care logging and follow up interaction. | [Watch JagaBot demo](./assets/videos/jagabot-demo.mp4) |
| JagaBoard | A family or care manager facing dashboard UI for reviewing structured care records and risk signals. | [Watch JagaBoard demo](./assets/videos/jagaboard-demo.mp4) |
...
TaigiSpeech Dataset  
https://huggingface.co/datasets/TaigiSpeech/TaigiSpeech

Taiwan Tongues ASR CE  
https://github.com/adi-gov-tw/Taiwan-Tongues-ASR-CE

IMA Taiwan Tongues Taigi Dataset  
https://huggingface.co/IMA-Taiwan

SARC Taigi LLM Demo  
https://llm.ivoice.tw:64441/

Speech AI Research Center on Hugging Face  
https://huggingface.co/Speech-AI-Research-Center

Speech AI Research Center GitHub  
